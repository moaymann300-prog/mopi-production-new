...
('home','contact','heading','Let Us Start','هيا نبدأ'),
('home','contact','heading2','A Conversation','الحديث معًا'),
('home','contact','subtitle','Tell us about your project and we will get back to you within 24 hours.','احكيلنا عن مشروعك وهنرد عليك خلال 24 ساعة.'),
...
ON CONFLICT (page, section, field) DO UPDATE SET
...
('about','hero','heading','About MOPI Production','عن موبي برودكشن'),
...
('portfolio','hero','heading','Our Portfolio','أعمالنا'),
...
('contact','hero','heading','Let Us Work Together','هيا نعمل سوياً'),
